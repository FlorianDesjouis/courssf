...
class TicketController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tickets = $em->getRepository('RouteBundle:Ticket')->findAll();
    ...
    {
        $ticket = new Ticket();
        $form = $this->createForm('RouteBundle\Form\TicketType', $ticket);
    ...
    {
        $deleteForm = $this->createDeleteForm($ticket);
        $editForm = $this->createForm('RouteBundle\Form\TicketType', $ticket);
